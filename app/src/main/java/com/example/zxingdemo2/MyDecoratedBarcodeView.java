 ...
 */
public class MyDecoratedBarcodeView extends FrameLayout {
    private MyBarcodeView barcodeView;
    private MyViewfinderView viewFinder;
    ...
    public MyDecoratedBarcodeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(attrs);
    }

    public MyDecoratedBarcodeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        barcodeView = (MyBarcodeView) findViewById(R.id.zxing_barcode_surface);

        if (barcodeView == null) {
            throw new IllegalArgumentException(
                    "There is no a MyBarcodeView on provided layout " +
        ...
        viewFinder = (MyViewfinderView) findViewById(R.id.zxing_viewfinder_view);

        if (viewFinder == null) {
            throw new IllegalArgumentException(
                    "There is no a MyViewfinderView on provided layout " +
    ...
    public MyBarcodeView getBarcodeView() {
        return (MyBarcodeView) findViewById(R.id.zxing_barcode_surface);
    }

    public MyViewfinderView getViewFinder() {
        return viewFinder;
    }
    ...
    public void setTorchListener(MyDecoratedBarcodeView.TorchListener listener) {
