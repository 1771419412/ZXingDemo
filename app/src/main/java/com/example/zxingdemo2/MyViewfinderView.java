...
public class MyViewfinderView extends View {
    protected static final String TAG = MyViewfinderView.class.getSimpleName();
    ...
    protected MyCameraPreview cameraPreview;
    ...
    public void setCameraPreview(MyCameraPreview view) {
        this.cameraPreview = view;
        view.addStateListener(new MyCameraPreview.StateListener() {
            @Override
