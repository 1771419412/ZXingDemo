 ...
 */
public class MyCameraPreview extends ViewGroup {
    ...
    private List<MyCameraPreview.StateListener> stateListeners = new ArrayList<>();
     ...
     */
    public void addStateListener(MyCameraPreview.StateListener listener) {
        stateListeners.add(listener);
    }

    private final MyCameraPreview.StateListener fireState = new MyCameraPreview.StateListener() {
        @Override
        public void previewSized() {
            for (MyCameraPreview.StateListener listener : stateListeners) {
