...
public class MyCaptureManager {
    ...
    private final MyCameraPreview.StateListener stateListener = new MyCameraPreview.StateListener() {
        @Override
    ...
    public MyCaptureManager(Activity activity, MyDecoratedBarcodeView barcodeView) {
    ...
    public static void setCameraPermissionReqCode(int cameraPermissionReqCode) {
        MyCaptureManager.cameraPermissionReqCode = cameraPermissionReqCode;
    }
}
